...
// const PaymentDetailInfo: React.FC<PaymentDetailProps> = ({ setActiveIndex, appointment }: PaymentDetailProps) => {

//     const [appointmentInfo, setAppointmentInfo] = useState<AppointmentViewModelFetch>(appointment);
...
//                     <p><strong>Thời gian thực hiện thanh toán:</strong></p>
//                 </div>
//             </div>
